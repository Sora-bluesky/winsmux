...
const WORKER_BACKENDS: &[WorkerBackendContract<'static>] = &[
    ...
    WorkerBackendContract {
        id: "antigravity",
        description: "Antigravity CLI worker slot metadata for terminal-first agent execution",
        runtime_available: false,
        config_fields: &[
            "worker_backend",
            "model",
    ...
    WorkerBackendContract {
        id: "local_llm",
        description: "PC-local LLM endpoint worker metadata and one-shot execution; initial runtime is Ollama",
        runtime_available: true,
        config_fields: &[
            "worker_backend",
            "runtime",
    ...
    WorkerBackendContract {
        id: "colab_llm",
        description: "Colab GPU LLM model-job metadata and one-shot execution through an adapter-managed Colab runtime",
        runtime_available: true,
        config_fields: &[
            "worker_backend",
            "runtime",
