...
winsmux has **first-class mouse support over SSH** when the server runs **Windows 11 build 22523+ (22H2+)**. Click panes, drag-resize borders, scroll, click tabs — everything works, from any SSH client on any OS.
...
Mouse works perfectly when running winsmux locally on both Windows 10 and 11.
...
> **Recommendation:** Use Windows 11 build 22523+ (22H2 or later) as your winsmux server for full SSH mouse support.
