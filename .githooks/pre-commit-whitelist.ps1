...
$whitelistPatterns = @(
    ...
    'docs/cli-comparison-bakeoff.ja.md',
    ...
    'scripts/new-cli-bakeoff-benchmark-run.ps1',
    'scripts/new-cli-bakeoff-harnessbench-pack.ps1',
    'scripts/new-cli-bakeoff-harnessbench-run-matrix.ps1',
    'scripts/new-cli-bakeoff-run.ps1',
    'scripts/summarize-cli-bakeoff.ps1',
    'scripts/test-cli-bakeoff-preflight.ps1',
    'scripts/test-cli-bakeoff-recording-ready.ps1',
    'scripts/test-local-llm-e2e.ps1',
    ...
    'tests/PublicSurfaceRuntimeReferences.Tests.ps1',
    ...
    'tests/ColabCliAdapter.Tests.ps1',
