...
$whitelistPatterns = @(
    ...
    'core/Cargo.toml',
    'core/Cargo.lock',
    'core/presets/workspace-presets-v1.yaml',
    'core/src/*.rs',
    'core/src/bin/*.rs',
    'core/src/operator_cli/workspace_migration.rs',
    'core/src/operator_cli/workspace_plan_resolution.rs',
    'core/tests-rs/*.rs',
    'git-graph/**',
    ...
    'tests/WorkspaceMigration.Tests.ps1',
    'tests/WorkspaceMigrationAuthority.Tests.ps1',
