...
$whitelistPatterns = @(
    ...
    'docs/benchmarks/task-760-refero-style-research.md',
    'docs/benchmarks/task-760-refero/*.png',
    ...
    'scripts/test-v03638-router-reliability.ps1',
    ...
    'winsmux-app/src/fleetProjection.css',
    'winsmux-app/src/fleetProjection.test.ts',
    'winsmux-app/src/fleetProjection.ts',
    'winsmux-app/src/sshConnectReview.css',
    'winsmux-app/src/sshConnectReview.test.ts',
    'winsmux-app/src/sshConnectReview.ts',
