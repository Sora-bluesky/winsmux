...
'@ -Encoding UTF8
    ...
    It 'runs packaged helper negative protocol and controller-boundary selectors' {
        ...
        foreach ($selector in @(
            ...
            'run_exact session_lifecycle runtime_dir_final_symlink_is_rejected_without_leftovers',
            'run_exact session_lifecycle resolution_without_agent_path_capability_rejects_before_agent_spawn',
