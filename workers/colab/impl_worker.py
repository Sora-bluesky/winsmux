#!/usr/bin/env python3
"""Self-contained implementation worker template for winsmux Colab slots."""
...
{bullet_list(commands, "Add focused tests for the changed behavior.")}

## Notes

- Keep the patch small and scoped to the requested behavior.
- Record assumptions and unresolved blockers in the JSON result.
"""
        ...
        "artifacts": [
            {
                ...
                "description": "Implementation plan and verification checklist.",
            }
        ],
        "observations": [],
        "risks": RISKS,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="winsmux Colab implementation worker template")
