...
- [クイックスタート](quickstart.ja.md) - インストール、プロジェクト設定、管理ワークスペース起動、最初のペイン操作までを進めます。
- [インストール](installation.ja.md) - 動作要件、インストールプロファイル、更新、アンインストール、パッケージの扱いを説明します。
...
- [tmux 互換性](../core/docs/compatibility.md) - 旧互換と alias の終了予定を説明します。
