...
1. PR [#419](https://github.com/Sora-bluesky/winsmux/pull/419) を `main` に追いつかせて conflict を解消する。
2. `TASK-291 / TASK-107` の残りとして、`appendFallbackExplain()` と editor empty-state を backend digest の事実だけにさらに寄せる。
