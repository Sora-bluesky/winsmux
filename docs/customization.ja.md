...
`v0.36.8` 時点では、デスクトップアプリ終了時の子プロセス回収はまだ製品として完了していません。この制限は [issue #967](https://github.com/Sora-bluesky/winsmux/issues/967) で追跡しています。完全な片付けが必要な場合は、終了後に関連するワーカーの shell とデスクトップ子プロセスが残っていないことを確認してください。
