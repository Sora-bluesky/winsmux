...
デスクトップ終了時の子プロセス回収は、引き続き [issue #967](https://github.com/Sora-bluesky/winsmux/issues/967) で追跡しています。外部クライアントは切断前にペインを明示的に閉じ、デスクトップアプリを閉じただけで全てのワーカー子プロセスが回収されたとは仮定しないでください。
