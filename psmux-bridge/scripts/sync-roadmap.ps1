...
[void]$builder.AppendLine('# Roadmap')
[void]$builder.AppendLine()
[void]$builder.AppendLine('> Auto-generated from `tasks/backlog.yaml` — do not edit manually.')
[void]$builder.AppendLine(('> Last sync: {0}' -f (Get-Date -Format 'yyyy-MM-dd HH:mm (zzz)')))
[void]$builder.AppendLine()
[void]$builder.AppendLine('## Version Summary')
[void]$builder.AppendLine()
[void]$builder.AppendLine('| Version | Tasks | Progress |')
[void]$builder.AppendLine('|---------|-------|----------|')
...
[void]$builder.AppendLine()
[void]$builder.AppendLine('## Work Breakdown')
[void]$builder.AppendLine()

foreach ($versionGroup in $versionGroups) {
    [void]$builder.AppendLine(('### {0}' -f $versionGroup.Name))
    [void]$builder.AppendLine()
...
[void]$builder.AppendLine('## Legend')
[void]$builder.AppendLine()
[void]$builder.AppendLine('| Symbol | Meaning |')
[void]$builder.AppendLine('|--------|---------|')
[void]$builder.AppendLine('| [x] | Done |')
[void]$builder.AppendLine('| [-] | In progress |')
[void]$builder.AppendLine('| [R] | In review |')
[void]$builder.AppendLine('| [ ] | Backlog / Ready |')
[void]$builder.AppendLine()
[void]$builder.AppendLine('| Priority | Meaning |')
[void]$builder.AppendLine('|----------|---------|')
[void]$builder.AppendLine('| P0 | Critical / Blocker |')
[void]$builder.AppendLine('| P1 | High |')
[void]$builder.AppendLine('| P2 | Medium |')
[void]$builder.AppendLine('| P3 | Low |')
