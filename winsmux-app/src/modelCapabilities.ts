...
export const evidenceRecords: readonly EvidenceRecord[] = [
  ...
  {
    id: "anthropic-claude-fable-5-2026-08-01",
    kind: "official-doc",
  ...
  {
    id: "anthropic-claude-opus-5-2026-08-01",
    kind: "official-doc",
    label: "Claude Opus 5",
  ...
  {
    id: "anthropic-claude-sonnet-5-2026-08-01",
    kind: "official-doc",
...
export const modelCapabilities: readonly ModelCapability[] = [
  ...
  },
  {
    ...
    note: "Strongest hosted Codex coding worker; use for hard implementation and review.",
    noteJa: "Codexで提供される最も強力なコーディング用ワーカーです。難しい実装やレビューに使用します。",
  },
  {
    id: "codex-gpt-5-6-terra",
    providerId: "codex",
    label: "GPT-5.6 Terra",
    labelJa: "GPT-5.6 Terra",
    model: "gpt-5.6-terra",
    modelSource: "cli-discovery",
    defaultEffortId: "medium",
    supportedEffortIds: ["low", "medium", "high", "max", "xhigh"],
    ...
    benchmark: "winsmux local model availability evidence",
    evidenceIds: ["cli-discovery"],
    note: "Default choice for routine implementation.",
    noteJa: "通常の実装でまず選ぶ、性能とコストのバランスに優れたモデルです。",
  },
  {
    id: "codex-gpt-5-6-luna",
    providerId: "codex",
    label: "GPT-5.6 Luna",
    labelJa: "GPT-5.6 Luna",
    model: "gpt-5.6-luna",
    modelSource: "cli-discovery",
    defaultEffortId: "medium",
    supportedEffortIds: ["low", "medium", "high", "max", "xhigh"],
    ...
    benchmark: "winsmux local model availability evidence",
    evidenceIds: ["cli-discovery"],
    note: "Use for mechanical edits and quick checks.",
    noteJa: "機械的な編集や短時間の確認に向いています。",
  },
  {
    id: "codex-gpt-5-5",
    providerId: "codex",
  ...
  },
  {
    ...
    evidenceIds: ["anthropic-claude-fable-5-2026-08-01"],
    note: "Fable 5 requires usage credits after 2026-07-07. Verify credits before long runs.",
    noteJa: "Fable 5は2026-07-07以降usage creditsが必要です。長時間実行前にcreditsを確認してください。",
  },
  {
    id: "claude-opus-5",
    providerId: "claude",
    label: "Claude Opus 5",
    labelJa: "Claude Opus 5",
    model: "claude-opus-5",
    modelSource: "official-doc",
    defaultEffortId: "high",
    supportedEffortIds: ["low", "medium", "high", "max", "xhigh"],
    ...
    cost: "account",
    risk: "local-cli",
    benchmark: "Official model catalog; benchmark evidence is separate.",
    evidenceIds: ["anthropic-claude-opus-5-2026-08-01"],
    note: "Use for complex agentic work when Claude Code access exposes Opus 5.",
    noteJa: "Claude CodeでOpus 5を利用できる場合の高難度エージェント作業向けです。",
  },
  {
    id: "claude-sonnet-5",
    providerId: "claude",
    label: "Claude Sonnet 5",
    labelJa: "Claude Sonnet 5",
    ...
    risk: "local-cli",
    benchmark: "Official model catalog; benchmark evidence is separate.",
    evidenceIds: ["anthropic-claude-sonnet-5-2026-08-01"],
    note: "Use for fast, balanced agentic work when Claude Code access exposes Sonnet 5.",
    noteJa: "Claude CodeでSonnet 5を利用できる場合の高速でバランスのよいエージェント作業向けです。",
  },
  {
    id: "claude-opus-4-8",
    providerId: "claude",
