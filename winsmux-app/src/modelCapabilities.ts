...
export const providerCapabilities: readonly ProviderCapability[] = [
  ...
  },
  {
    ...
    dynamicModelLoading: {
      ...
      seedModelIds: ["openrouter-glm-5-2", "openrouter-kimi-k2-7-code"],
    },
    readiness: {
...
export const modelCapabilities: readonly ModelCapability[] = [
  ...
  },
  {
    ...
    authMode: "claude-pro-max-oauth",
    requiredBackend: "agent-cli",
    readiness: { state: "unavailable", assignable: false, availability: "Anthropic suspended Fable 5 access on 2026-06-12." },
    family: "agent-arena",
    speed: "frontier",
    intelligence: "high",
    cost: "account",
